...
/**
 * Model class that encapsulate all the basic details about a Payee entity
 */
public class Payee {
    @Id
    private int id;
    ...
    public Payee(int id, String name, String address, Set<PaymentMethod> paymentMethods) {
        this.id = id;
        this.name = name;
        this.address = address;
